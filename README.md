...
> Returns : elem | clones
> usage : **`$cloneAndReplace([elem1,elem2])`**
...
> Returns : undefined
> usage : **`$addChildren([elem1,elem2,'txt'],parentElem)`**
...
> Returns : Array
> usage : **`$cs('@width,@height',elem1)`** **`$cs('color,@padding',elem2)`**
...
> Returns : undefined
> usage : **`$style('color:red,font-size:2em',elem1)`** **`$style('color:!black')`**
...
> Returns : Undefined
> usage : **`$addCssRule('#id{color:white; background:black}')`**
...
> Returns : Undefined
> usage : **`$removeCssRule( { rule:'body{overflow:hidden}', sheet:styleElem } )`** **`$removeCssRule( { selector:'no_overflow', sheet:styleElem } )`**
...
> usage : **`$parseNum("str 123 124 125.5 str end") : returns array[123,124]`** **`$parseNum("str 123 124 125.5 str end",true) : returns array[123,124,125.5]`**
...
> Returns : undefined
> usage : **`$scrolltoElem('#id')`** **`$scrolltoElem('.class')`**
...
> Returns : undefined
> usage : **`$switchPositions(elem1, elem2)`**
...
> Returns : boolean
> usage : **`$isElem(textNode) : return false`**
